        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex flex-col items-center md:items-start gap-4">
            <Link to="/" className="flex items-center gap-2">
              <img src={logoImg} alt="TokenPicks" className="w-8 h-8 rounded-lg" />
              <span className="text-lg font-bold tracking-tight text-ink">Token<span className="font-extrabold">Picks</span></span>
            </Link>
            <p className="text-body-sm text-ink-faint">
              {currentYear} TokenPicks. All rights reserved.
            </p>
          </div>
          ...
          <div className="flex items-center gap-4">
            {socialLinks.map((social) => (
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="w-10 h-10 flex items-center justify-center rounded-full bg-canvas-alt text-ink-muted hover:bg-ink hover:text-canvas transition-all duration-300"
